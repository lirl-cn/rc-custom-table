...
var CustomTable = /** @class */ (function (_super) {
    ...
    function CustomTable(props) {
        ...
        _this.renderItem = function (data) {
            ...
            return react_1.default.createElement("div", { key: data.key, className: "custom-table-item", style: { flex: data.column || 1 } },
                react_1.default.createElement("div", { className: 'custom-table-item-label', style: { width: labelWidth || 120 } },
                    data.required && react_1.default.createElement("span", { className: 'custom-table-item-label-required' }, "*"),
                    data.label),
                react_1.default.createElement("div", { className: 'custom-table-item-value' }, data.value));
        };
        ...
        _this.renderContent = function (dataSource, column) {
            ...
            for (var i = 0, len = dataSource.length; i < len;) { //遍历数据源，进行渲染
                ...
                content.push(react_1.default.createElement("div", { className: "custom-table-row", key: i + "-" + item.label }, index.map(function (it) { return _this.renderItem(__assign({}, dataSource[it] || {}, { key: it })); }))); //遍历添加改行每个元素
            }
    ...
    CustomTable.prototype.render = function () {
        ...
        return react_1.default.createElement("div", { className: "custom-table-container " + (className || '') }, this.renderContent(dataSource, column));
    };
    return CustomTable;
